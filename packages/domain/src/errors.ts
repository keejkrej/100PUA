...
export class UnknownPrompt extends Schema.TaggedError<UnknownPrompt>()("UnknownPrompt", {
...
export class TopicNotFound extends Schema.TaggedError<TopicNotFound>()("TopicNotFound", {}) {}
