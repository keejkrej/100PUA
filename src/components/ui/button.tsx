...
export const buttonVariants = cva(
  "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 rounded-lg border text-sm font-medium transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent/40 disabled:pointer-events-none disabled:opacity-50",
  {
    ...
    variants: {
      ...
      variant: {
        default: "border-accent/40 bg-accent/10 text-accent hover:bg-accent/20",
        ghost: "border-transparent bg-transparent text-muted hover:bg-muted/15 hover:text-text",
        ...
        subtle: "border-muted/40 bg-void text-text hover:border-accent/50 hover:text-accent",
      },
    },
  },
);
